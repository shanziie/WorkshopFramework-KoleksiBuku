      ...
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{ route('kategori.store') }}" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('nama_kategori') is-invalid @enderror" id="nama_kategori" name="nama_kategori" placeholder="Contoh: Fiksi Ilmiah" value="{{ old('nama_kategori') }}" required>
            @error('nama_kategori')
